            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Register Akun Guru</h4>
                                ...
                                <form action="<?= baseURL?>/Models/helper/register/register-pembimbing.php" enctype="multipart/form-data"  method="POST" class="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputAddress" placeholder="Alamat" name="alamat"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputNumber">No HP</label>
                                        <input type="number" class="form-control" id="exampleInputNumber" placeholder="No HP" name="noHp"/>
                                    </div>
                                    <div class="form-group">
                                        <label>File upload</label>
                                        <input type="file" id="upload_foto" name="foto_profile"  class="file-upload-default"/>
                                        <div class="input-group col-xs-12">
                                            <input type="text" class="form-control file-upload-info" disabled placeholder="Tambahkan Foto Profile"/>
