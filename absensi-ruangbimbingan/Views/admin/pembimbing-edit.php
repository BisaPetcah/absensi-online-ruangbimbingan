                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="guru">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href="daftar.php"> Daftar Guru </a></li>
                            <li class="nav-item"><a class="nav-link" href="tambah.php"> Tambah Guru </a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php 
                                    if(isset($_POST['ubah'])){
                                        echo ubahProfileGuru($conn, $_POST, $_FILES, $id);
                                    }
                                ?>
                            </div>
                        </div>
