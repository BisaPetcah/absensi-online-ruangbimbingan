...
$daftarCatatan = daftarCatatanPembimbing($conn, $id_user);
headMain($tittle = "Daily Report | Program Catatan", $href = baseURL);
?>
							...
							<div class="card-body">
								...
								<div class="table-responsive">
									<table class="table table-striped">
										...
										<tbody>
											<?php while($data = mysqli_fetch_assoc($daftarCatatan)): ?>
													<tr>
														<th><?= $data['catatan_tanggal']?></th>
														<td>
															<p><?= $data['catatan_isi']?></p>
														</td>
													</tr>
											<?php endwhile ;?>
										</tbody>
