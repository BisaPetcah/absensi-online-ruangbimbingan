                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?= baseURL ?>Models/helper/pembimbing/tambahCatatan.php" method="POST" class="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="exampleTextarea1" rows="5" placeholder="Masukkan catatan" name="catatan"></textarea>
                                    </div>
