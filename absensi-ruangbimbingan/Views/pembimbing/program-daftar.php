										...
										<tbody>
											<?php //foreach ($daftar as $data) : ?>
												<tr>
													...
													<td>
														<div class="btn-group">
															<a class="btn btn-warning btn-sm btn-icon-text" href="edit.php?id=<?= $data['id_kelas'] ?>">Edit<i class="mdi mdi-pencil btn-icon-append"></i></a>
															<a class="btn btn-danger btn-sm btn-icon-text" href="../aksi/guru/deleteKelas.php?id=<?= $data['id_kelas'] ?>">Hapus<i class="mdi mdi-delete btn-icon-append"></i></a>
														</div>
													</td>
												</tr>
											<?php //endforeach; ?>
